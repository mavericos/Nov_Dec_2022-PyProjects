# Build a screen and moving block
import random
import pygame
from pygame.locals import *
import time
#  https://www.youtube.com/watch?v=8dfePlONtls&list=PLnbmk43t7uQON3m98Biq1UOwt78bDQrZ9&index=31
